...
class PrefsHelper {
  ...
  static const String _legacyKeyAppData = 'cached_app_data';
  static const String _keyAppData = 'cached_app_data_${AppIdentity.appId}';
  ...
  // ---- Bookmarks ----
  static const String _bookmarkKey = 'bookmark_questions_${AppIdentity.appId}';
  ...
  // ---- Learning Stats ----
  static const String _keyTotalAnswered = 'total_answered_${AppIdentity.appId}';
  static const String _keyBestStreak = 'best_streak_${AppIdentity.appId}';
  static const String _keyDailyAnswered = 'daily_answered_${AppIdentity.appId}';
  static const String _keyDailyBestStreak =
      'daily_best_streak_${AppIdentity.appId}';
  static const String _keyCatAnsweredPrefix =
      'cat_answered_${AppIdentity.appId}_';
  static const String _keyCatCorrectPrefix =
      'cat_correct_${AppIdentity.appId}_';

  static const String legacyBookmarkKey = 'bookmark_questions_unkou';
  static const String legacyTotalAnsweredKey = 'total_answered_unkou';
  static const String legacyBestStreakKey = 'best_streak_unkou';
  static const String legacyDailyAnsweredKey = 'daily_answered_unkou';
  static const String legacyDailyBestStreakKey = 'daily_best_streak_unkou';
  static const String legacyCatAnsweredPrefix = 'cat_answered_unkou_';
  static const String legacyCatCorrectPrefix = 'cat_correct_unkou_';

  static Future<String?> getLegacyAppDataCache() async {
    final prefs = await SharedPreferences.getInstance();
    return prefs.getString(_legacyKeyAppData);
  }
